...
export default function AppLayout({ children, params }) {
  const highlightOnActive = (tab) =>
    params.tab === tab ? 'stroke-white fill-white' : 'stroke-slate-500 fill-slate-500'
  ...
  return (
    <div className='h-full grid grid-cols-1 grid-rows-[1fr_60px]'>
      ...
      <div className='bg-neutral-900 grid grid-cols-5 justify-items-center items-center font-bold text-lg text-white'>
        <Link href='/home'>
          <div className={highlightOnActive('home')}>
        ...
        <Link href='/standouts'>
          <div className={highlightOnActive('standouts')}>
        ...
        <Link href='/likes-you'>
          <div className={highlightOnActive('likes-you')}>
        ...
        <Link href='/matches'>
          <div className={highlightOnActive('matches')}>
            <svg
        ...
        <Link href='/settings'>
          <div className={highlightOnActive('settings')}>
